...
def converter_temperatura():
  ...
  try:
   tipo = input("Você quer converter para qual unidade de temperatura? celsius/fahrenheit")
   numero = float(input("Selecione um valor:"))
  except ValueError:
    print(print("Erro! O numero digitado precisa ser um número!"))

  if(tipo == "celsius"):
    print("O valor convertido para Celsius é: ", fahrenheit_para_celsius(numero))
  elif(tipo == "fahrenheit"):
    print("O valor convertido para fahrenheit é: ", celsius_para_fahrenheit(numero))
  else:
    print("Erro! Um dos parametros está incorreto")
